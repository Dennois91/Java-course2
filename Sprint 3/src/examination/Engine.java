...
public class Engine {
    ...
    public List<JButton> moveButtonValue(int buttonId,List<JButton> buttons) {


        // Check if button is next to 16
        if (isMoveable(buttonId)) {
            System.out.println(buttonId);
            buttonValues.replace(16,buttonId);
            buttonValues.replace(buttonId,16);
            ...
            for (JButton button : buttons){
                ...
                button.setText(String.valueOf(buttonValues.get(i)));
                i++;
